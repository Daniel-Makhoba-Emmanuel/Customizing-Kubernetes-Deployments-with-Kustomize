...
const Index = () => {
  const [environment, setEnvironment] = useState('...'); // Initial loading state
  const apiEndpoint = '/api/environment'; // Define the API endpoint

  // This hook runs once when the component mounts to fetch the environment variable
  useEffect(() => {
    const fetchEnvironment = async () => {
      try {
        ...
        setEnvironment('unknown environment'); // Fallback for errors
      }
    };
    fetchEnvironment();
